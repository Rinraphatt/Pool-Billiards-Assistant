...
while True:
    ...
    # upper_green = np.array([30,90,200])
    ...
    circles = cv.HoughCircles(cropped_Blur_image, cv.HOUGH_GRADIENT, 1.4, 30,
                                param1=100, param2=22, minRadius=15, maxRadius=30)
    ...
    if circles is not None:
        ...
        for i in range(len(circleZones)):
            ...
            if maxSameColorPos == 8 and maxSameColor < 1400:
