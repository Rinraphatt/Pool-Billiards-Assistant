...
def gameOver():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2, text="GAME OVER", font=('consolas', 70), fill="red", tags="gameover")
...
canvas = Canvas(window, background=BG_COLOR, width=GAME_WIDTH, height=GAME_HEIGHT)
canvas.pack()
